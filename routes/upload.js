...
app.put('/:tipo/:id', (req, res, next) => {
    ...
    var extencionesValidas = ['jpg', 'png', 'gif', 'jpeg'];
    ...
    archivo.mv(path, err => {
        ...
        moverPorTipo(tipo, id, nombreArchivo, res);
...
function moverPorTipo(tipo, id, nombreArchivo, res) {
    if (tipo === 'usuarios') {
